...
public class Event {
   ...
   private final double metricD;

   public Event(String host, String service, String state, String description, List<String> tags, long time, float ttl, long metric, double metricD) {
      this.host = host;
   ...
   public boolean equals(Object o) {
      ...
      if (metric != event.metric) {
         return false;
      }
      if (Double.compare(event.metricD, metricD) != 0) {
         return false;
      }
      if (time != event.time) {
         return false;
   ...
   public int hashCode() {
      ...
      result = 31 * result + (int) (metric ^ (metric >>> 32));
      temp = Double.doubleToLongBits(metricD);
